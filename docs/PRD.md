...
> **Status: DRAFTED (AI-drafted, pending professional review).** `docs/compliance/owasp-llm-top10.md` maps all ten LLM0X:2025 risks across threat / structural-in-code / operator-configured / residual / operator-responsibility with resolving repo-path citations, cross-checked against HONEST-STATE caveats.
...
7. **Compliance Alignment Pack** (`docs/compliance/`, M1; per §1.8 and §8 M1 deliverables) — the document set mapping LQ.AI's design choices to SOC 2, ISO 27001, ISO 42001, GDPR, HIPAA, FedRAMP controls. Component documents: `soc2-alignment.md`, `iso-27001-alignment.md`, `iso-42001-alignment.md`, `gdpr-readiness.md`, `hipaa-readiness.md`, `provider-compliance-matrix.md`, and `owasp-llm-top10.md` (OWASP LLM Top 10 2025 mapping, per DE-224 — drafted). FedRAMP and state-privacy alignment documents follow in v1.x or M2.
