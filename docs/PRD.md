...
Local implementation now includes [strict plan and consent contracts](plans/issue-563-contracts.md):
bounded model-authored tasks, server-owned execution scope and complete approval
binding. Dispatch, durable approval and the public orchestration interface remain
unimplemented; the [workflow](plans/issue-563-workflow.md) records acceptance progress.
