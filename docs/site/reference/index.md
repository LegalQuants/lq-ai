...
reads, which the page's own commit stamp names.
...
read instead. Once the site is built, they live at `/reference/configuration/`,
`/reference/skill-frontmatter/` and `/reference/adr-index/`.
