---
title: Move machines or uninstall
description: What to export before you move host or remove LQ.AI, and why one flag is irreversible.
audience: [operator]
status: draft
sources:
  - docker-compose.yml
  ...
  - api/app/workers/user_export.py
  - api/app/workers/user_deletion.py
sidebar:
  order: 27
---
