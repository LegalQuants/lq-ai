...
**Status:** Proposed (2026-06-29) — pending maintainer acceptance. Implementation PRs (WS-E PR1+) carry **security review** per CODEOWNERS (the `gateway/**` egress boundary, the `api/app/autonomous/**` governance chokepoint, and a new external-egress surface).
