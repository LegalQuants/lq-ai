...
| **Air-gap install verification** ([`air-gap-verification.md`](air-gap-verification.md)) | Landed (DE-032 + DE-233); AI-drafted pending review | CI-proven zero-egress install of Mode 2 (`--profile local`): sealed-network boot + Tier-1 smoke + pcap evidence, plus the operator BOM, pre-fetch checklist, and offline degradation list. |
