...
| **SLSA Provenance** (`releases/`) | Landed (Phase E); Build L3 after v0.7.1 | SLSA build provenance attestations, generated by `actions/attest-build-provenance` in the [`build-image.yml`](../../.github/workflows/build-image.yml) reusable workflow. Build Level 3 from the first release after v0.7.1; releases up to v0.7.1 carry Build Level 2 provenance. See [Release verification](releases/README.md#verify-the-slsa-build-provenance). |
