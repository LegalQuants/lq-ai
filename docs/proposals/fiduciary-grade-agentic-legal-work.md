...
- **P1-B1b — Paraphrase judge + cost pre-flight (WS-B).** Wires [DE-280](../PRD.md#de-280)'s opinion-scale content-accuracy judge as the SUPPORTED/paraphrase tier for caselaw, persists caselaw FAIL attempts, and adds the long-opinion cost pre-flight ([DE-344](../PRD.md#de-344)). New gateway egress + R4 cost → heavier security review; the high-fan-out cost lever is the target of [DE-360](../PRD.md#de-360) (gateway-native escalation routing).
