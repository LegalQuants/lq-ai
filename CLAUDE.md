...
- **End-to-end tests** — the deterministic Cypress track runs nightly and on manual dispatch (`.github/workflows/e2e.yml`), not on every PR; the live-model track stays opt-in.
